$(document).ready(function(){
	var id_planta;
	var url_del = $("#eliminar_area").attr('href');
	var url_edit = $("#editar_area").attr('href');
	var volver = $("#eliminar_area").attr('rel');
	$("input[type=radio]").click(function(){
		id_planta =  $(this).val();
		url_final_del = url_del + '/' + id_planta + '/' + volver;
		url_final_edit = url_edit + '/' + id_planta;
		$("#eliminar_area").attr('href',url_final_del);
		$("#editar_area").attr('href',url_final_edit);
	});
