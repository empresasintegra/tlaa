...
class Tla_auditoria_registros extends CI_Model {
      ...
      function listar(){
		$this->db->SELECT('tla_auditoria_registro.id,tla_auditoria_registro.tabla_id,usuarios.nombres,usuarios.paterno,tla_auditoria_registro.fecha,tla_auditoria_registro.accion');	
