...
class personal_model extends CI_Model {                
	...
	function listar_nuevos_trabajadores_choferes($fecha_trabajar){
		$query = $this->db->query("select p.id as id, p.nombre as nombre, p.apellido_paterno as ap, apellido_materno as am, t.id_cargo as cargo, t.id_instrumento_colectivo as colectivo	
			FROM trabajador t
