<form action="<?php echo base_url() ?>transportes/asignacion/add_chofer" role="form" id="form2" method='post' name="f2" autocomplete="off">
			...
			if ($choferes != FALSE){
				foreach ($choferes as $row){
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="radio"  
							value="<?php echo $row->id; ?>"; name="chofer[]" id="id_chofer[]"/> 
