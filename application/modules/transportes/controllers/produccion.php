...
class Produccion extends CI_Controller {
	...
	public function consolidado_produccion(){
		$base = array(
		...
		$pagina = "";
		$base['cuerpo'] = $this->load->view('transportes/produccion/consolidado_produccion', $pagina, TRUE);
		$this->load->view('layout2.0/layout',$base);
	}

	function genera_informe_general (){
		...
		$todos_los_trabajadores = $this->tla_informe_produccion->todos_los_trabajadores($f_inicio, $f_termino);
...
/* Location: ./application/modules/transportes/controllers/produccion.php */