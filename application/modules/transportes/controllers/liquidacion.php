...
$diahoy =date('Y-m-d');
 ...
 $iniciomes1 = new DateTime('first day of this month');
 $iniciomes = $iniciomes1->format('Y-m-d') ;
 


 $findemes1 = new DateTime('last day of this month');
 $findemes = $findemes1->format('Y-m-d');

 $resultado = $this->usuarios_model->verificar_registro($iniciomes,$findemes);
...
if ($resultado1 == 0 ){
	...
	$datos = array('fecha_cierre' => $diahoy );

$this->usuarios_model->insertar_fecha($datos);
...
$resultado = $this->usuarios_model->verificar_registro($fecha_inicio,$fecha_termino);
...
$this->email->to('ptorres@empresasintegra.cl');
...
echo "<script>alert('ya se realizo el cierre este mes')</script>";
