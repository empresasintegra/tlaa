...
<html lang="en" class="no-js">
	<head>
		<title>Login - Transportes Integra</title>
		<meta charset="utf-8" />
					...
					<form class="form-login" action="<?php echo base_url() ?>usuarios/login/validar" method='POST'>
						...
						<fieldset>
							...
							<div class="form-group form-actions">
								...
								<a href="<?php echo base_url()?>usuarios/login/cambiar_contrasena">cambiar contraseña </a>
								<a href="<?php echo base_url()?>usuarios/login/recuperar_contrasena">¿olvidaste tu contraseña?</a>
