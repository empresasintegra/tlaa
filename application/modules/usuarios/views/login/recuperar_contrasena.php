...
<html lang="en" class="no-js">
	<head>
		<title>Recuperar Contraseña - Transportes Integra</title>
		<meta charset="utf-8" />
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-login">
					...
					<form class="form-login" action="<?php echo base_url() ?>usuarios/login/comprobar_correo" method='POST'>
						...
						<fieldset>
							<div class="form-group">
								<span class="input-icon">
									<input type="text" class="form-control" name="recuperar_contrasena" placeholder="usuario@empresasintegra.cl" required>
									<i class="fa fa-envelope "></i> </span>
							</div>
							
							<div class="form-actions">
								<button type="submit" class="btn btn-green pull-right">
									Recuperar Contraseña <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
						</fieldset>
