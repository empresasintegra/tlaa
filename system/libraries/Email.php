...
class CI_Email {
	...
	var	$smtp_host		= "smtp.empresasintegra.cl";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "nrojas@empresasintegra.cl";		// SMTP Username
	var	$smtp_pass		= "integra*#rojas2019";		// SMTP Password
