		...
		<div class="e-slider owl-carousel owl-theme">
			<div class="item">
				<div class="panel-body">
					<div class="core-box">
						<div class="text-white text-bold space15">
							BIENVENIDOS
						</div>
						<div class="space5">
							<div class="row">
								...
								<div class="col-md-9">
									<font SIZE="3"><p align="justify" style="text-indent: 1cm;">
									Damos la bienvenida al Sistema de Gestión de Operaciones (Transportes), el cual tiene un enfoque basado en procesos, y determinación de funciones y actividades relacionadas entre sí, permitiendo que los recursos y elementos de entrada se gestionen y se transformen, con el fin de satisfacer a nuestros clientes a través del cumplimiento de sus requisitos.<br>
									El Sistema de Transportes, enfatiza la importancia de:<br>
									<ul>
										<li> <p align="justify" >a) La comprensión y cumplimiento de los requisitos de los trabajadores y de las de las partes interesadas</li>
										<li>  <p align="justify" >b) La necesidad de considerar los procesos en términos que aporten valor, considerando que los procesos del sistema se enfocan para satisfacer las necesidades y expectativas de las partes interesadas.</li>
										<li> <p align="justify" >c) La obtención de resultados del desempeño y eficacia del proceso, mediante el Seguimiento y medición de procesos.</li>
										<li> <p align="justify" >d) La mejora continua de los procesos para incrementar su habilidad para cumplir con los requerimientos, expectativas del cliente y los procesos internos. </li>
									</ul>
									...
									<p align="justify" >Transportes Integra Ltda., Se encuentra certificada bajo el modelo de gestión ISO9001 ver.2008., donde la metodología PHVA ha sido desplegada en cada uno de los procesos, la cual define sus interfaces e interacciones, en:<br><br>
									...
									<b>“Actuar”</b> es: Tomar las acciones para mejorar continuamente el desempeño de los procesos.<br></p>
								...
								<div class="col-md-2">
									<img src="<?php echo base_url() ?>extras/images/iso.jpg" style="width:140px; position: absolute; bottom: -440px;">
								</div>
							</div>
						</div>
					</div>
