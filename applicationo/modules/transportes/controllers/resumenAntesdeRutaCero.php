		...
		if (!empty($_POST['usuarios'])){
			foreach($_POST['usuarios'] as $row=>$valores){
				...
				if ($cargo == 72 and $convenio == 21) {
					...
					$archivo = "extras/tla_excel/liquidacion_chofer_sindicato_conv_antiguo.xlsx";
				...
				//CREAR VALORES
					...
					$objWriter->save(BASE_URL2."extras/tla_excel/liquidaciones_tla/".$data->ap."_".$data->am."_".$rut.".xlsx");
				}
...
//chofer convenio nuevo*******************************************************************************
				...
				if ($cargo == 72 and $convenio == 22) {
					...
					$objPHPExcel = new PHPExcel();
					$objReader = PHPExcel_IOFactory::createReader('Excel2007');
					$archivo = "extras/tla_excel/liquidacion_chofer_sindicato_conv_nuevo.xlsx";
					$objPHPExcel = $objReader->load(BASE_URL2.$archivo);
...
//*******************************************************************************************chofer_sin_nada....
				if ($cargo == 72 and $convenio == 23) {
					...
					$objPHPExcel = new PHPExcel();
					$objReader = PHPExcel_IOFactory::createReader('Excel2007');
					$archivo = "extras/tla_excel/liquidacion_chofer_solo.xlsx";
					$objPHPExcel = $objReader->load(BASE_URL2.$archivo);
...
//*******************************************************************************************peoneta sindicato_antiguo
				if ($cargo == 73 and $convenio == 21) {
					$objPHPExcel = new PHPExcel();
					$objReader = PHPExcel_IOFactory::createReader('Excel2007');
					$_archivo = "extras/tla_excel/liquidacion_peoneta_sindicato_conv_antiguo.xlsx";
...
//************************************************************************************************************************peoneta sindicato_nuevo
				if ($cargo == 73 and $convenio == 22) {
					...
					$objPHPExcel = new PHPExcel();
					$objReader = PHPExcel_IOFactory::createReader('Excel2007');
					$_archivo = "extras/tla_excel/liquidacion_peoneta_sindicato_conv_nuevo.xlsx";
					$objPHPExcel = $objReader->load(BASE_URL2.$_archivo);
					$nombre_completo = $data->nombre.$espacio.$data->ap.$espacio.$data->am;
					$rut = $data->rut;
					$cargo = isset($data->n_cargo)?$data->n_cargo:'';
...
//*******************************************************************************************peoneta solo...
				if ($cargo == 73 and $convenio == 23) {
					...
					$objPHPExcel = new PHPExcel();
					$objReader = PHPExcel_IOFactory::createReader('Excel2007');
					$_archivo = "extras/tla_excel/liquidacion_peoneta_solo.xlsx";
					$objPHPExcel = $objReader->load(BASE_URL2.$_archivo);
