...
<li><a href="javascript:void(0)"><i class="fa fa-briefcase"></i> <span class="title" > Reportes</span><i class="icon-arrow"></i> </a>
	<ul class="sub-menu">		
		...
		<li><a href="<?php echo base_url() ?>transportes/reportes/reporte_cliente"><i class="fa fa-user"></i> Reporte Clientes</a></li>
		<li><a href="<?php echo base_url() ?>transportes/reportes/reporte_cajas"><i class="fa fa-user"></i> Reportes Cajas</a></li>
	</ul>
</li>
